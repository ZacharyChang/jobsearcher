...
<html>
<head>
<title>图片搜索引擎网站模板WWW.777MOBAN.COM</title>
...
<body>
	<div class="header">
      <div class="container"> 
  	     <div class="logo">
			<h1><a href="index.jsp">Photo Hub</a></h1>
		 </div>
		 <div class="top_right">
		   <ul>
	...
	<div class="banner">
		<div class="container">
			<div class="span_1_of_1">
			    <h2 class="text-capitalize">Find your job here!<br><br><br><br></h2>
			    <div class="search">
			      <ul class="nav1">
		            <li id="search">
						<form action="/search" method="get">
							<input type="text" name="query" id="search_text" placeholder="Search"/>
							<input type="button" name="search_button" id="search_button" onclick="submit()">
						</form>
					</li>
					<li id="options">
						<a href="#">友情链接</a>
						<ul class="subnav">
							<li><a href="http://zhaopin.baidu.com/">百度招聘</a></li>
